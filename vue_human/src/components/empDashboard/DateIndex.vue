<template>
  ...
  <div class="dateIndex">
    <!--选择下拉-->
     <div class="dateTop">
       <el-select v-model="currentYear" @change="pickPre"
                  clearable placeholder="请选择"
                  style="width: 100px" size="mini">
         <el-option v-for="(item, index) in selectYearList" :key="index"
                    :label="item" :value="item">
         </el-option>
       </el-select>
       <el-select v-model="currentMonth" @change="pickPre"
                  clearable placeholder="请选择" style="width: 70px" size="mini">
         <el-option v-for="(item, index) in selectDayList"
