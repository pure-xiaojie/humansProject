<template>
  <el-form ref="form" :model="emp" :rules="rules" label-width="80px">
    <el-form-item label="用户昵称" prop="name">
      <el-input v-model="emp.name"/>
    </el-form-item>
    <el-form-item label="手机号码" prop="phone">
      <el-input v-model="emp.phone" maxlength="11"/>
    </el-form-item>
    <el-form-item label="地址" prop="address">
      <el-input v-model="emp.address" maxlength="50"/>
    </el-form-item>
    <el-form-item label="邮箱" prop="remark">
      <el-input v-model="emp.email" maxlength="50"/>
    </el-form-item>
    <el-form-item>
