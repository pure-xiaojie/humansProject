  ...
  <div>
    ...
    <div>
      ...
      <div  class="topInfo">
        <!--left button-->
        <div>
          <el-input placeholder="请输入职姓名搜索…" class="topLeft" size="small"
        ...
        <el-row  style="margin-top: 15px">
          <el-col :span="4">
            ...
            <el-popover placement="right"
                        ...
                        trigger="manual" v-model="searchDepVisible">
              <!--数据展示在tree中-->
              <el-tree :data="depList" :props="defaultProps"
                       default-expand-all @node-click="SearchHandleNodeClick"></el-tree>

              <!--部门选择按钮-->
              <div slot="reference" style="width: 130px" class="departmentClass" @click="showSearchDepView">
                {{inputDepName}}
              </div>
            </el-popover>
          </el-col>
  ...
  export default {
    ...
    methods: {
      ...
      SearchHandleNodeClick(data) {
        this.searchDepVisible = !this.searchDepVisible;
        this.inputDepName = data.name;
